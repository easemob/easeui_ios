...
- (void)_setupSubviews
{
    ...
    bgImageView.image = [UIImage imageNamed:@"EaseUIResource.bundle/callBg.png"];
    ...
    [_silenceButton setImage:[UIImage imageNamed:@"EaseUIResource.bundle/call_silence"] forState:UIControlStateNormal];
    [_silenceButton setImage:[UIImage imageNamed:@"EaseUIResource.bundle/call_silence_h"] forState:UIControlStateSelected];
    ...
    [_speakerOutButton setImage:[UIImage imageNamed:@"EaseUIResource.bundle/call_out"] forState:UIControlStateNormal];
    [_speakerOutButton setImage:[UIImage imageNamed:@"EaseUIResource.bundle/call_out_h"] forState:UIControlStateSelected];
