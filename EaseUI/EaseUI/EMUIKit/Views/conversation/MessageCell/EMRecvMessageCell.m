...
- (void)configureLayoutConstraints
{
    ...
    //status button
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.statusButton attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self.bubbleView attribute:NSLayoutAttributeRight multiplier:1.0 constant:EaseMessageCellPadding]];
}
...
+ (CGFloat)cellHeightWithModel:(id<IMessageModel>)model
{
    ...
    CGFloat height = cell.messageNameHeight - EaseMessageCellPadding + [EaseMessageCell cellHeightWithModel:model];
