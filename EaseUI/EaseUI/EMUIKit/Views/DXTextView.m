...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [DXTextView maxCharactersPerLine];
...
{
    return [DXTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [DXTextView maxCharactersPerLine]) + 1;
}
