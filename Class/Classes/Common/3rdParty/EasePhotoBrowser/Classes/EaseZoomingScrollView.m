...
@interface EaseZoomingScrollView () {
...
@implementation EaseZoomingScrollView
...
- (id)initWithPhotoBrowser:(EasePhotoBrowser *)browser {
    if ((self = [super init])) {
		...
		_tapView = [[EaseTapDetectingView alloc] initWithFrame:self.bounds];
		...
		// Image view
		_photoImageView = [[EaseTapDetectingImageView alloc] initWithFrame:CGRectZero];
