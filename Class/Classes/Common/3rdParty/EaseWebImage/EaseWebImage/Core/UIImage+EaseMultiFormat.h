 ...
 */
@interface UIImage (EaseMultiFormat)
#pragma mark - Decode
/**
...
/**
 ...
 @note If the receiver is `EaseAnimatedImage`, this will return the animated image data if available. No more extra encoding process.
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)Ease_imageDataAsFormat:(EaseImageFormat)imageFormat NS_SWIFT_NAME(Ease_imageData(as:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)Ease_imageDataAsFormat:(EaseImageFormat)imageFormat compressionQuality:(double)compressionQuality NS_SWIFT_NAME(Ease_imageData(as:compressionQuality:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)Ease_imageDataAsFormat:(EaseImageFormat)imageFormat compressionQuality:(double)compressionQuality firstFrameOnly:(BOOL)firstFrameOnly NS_SWIFT_NAME(Ease_imageData(as:compressionQuality:firstFrameOnly:));
