...
@class EaseImageCacheConfig;
/**
 A protocol to allow custom memory cache used in EaseImageCache.
 */
@protocol EaseMemoryCache <NSObject>
 ...
 */
- (nonnull instancetype)initWithConfig:(nonnull EaseImageCacheConfig *)config;
 ...
 */
@interface EaseMemoryCache <KeyType, ObjectType> : NSCache <KeyType, ObjectType> <EaseMemoryCache>

@property (nonatomic, strong, nonnull, readonly) EaseImageCacheConfig *config;
