...
/**
 A protocol to allow custom disk cache used in EaseImageCache.
 */
@protocol EaseDiskCache <NSObject>
 ...
 */
- (nullable instancetype)initWithCachePath:(nonnull NSString *)cachePath config:(nonnull EaseImageCacheConfig *)config;
 ...
 */
@interface EaseDiskCache : NSObject <EaseDiskCache>
/**
 Cache Config object - storing all kind of settings.
 */
@property (nonatomic, strong, readonly, nonnull) EaseImageCacheConfig *config;
