...
typedef NSString * EaseImageCoderOption NS_STRING_ENUM;
typedef NSDictionary<EaseImageCoderOption, id> EaseImageCoderOptions;
typedef NSMutableDictionary<EaseImageCoderOption, id> EaseImageCoderMutableOptions;
...
/**
 ...
 @note works for `EaseImageCoder`.
 */
FOUNDATION_EXPORT EaseImageCoderOption _Nonnull const EaseImageCoderDecodeFirstFrameOnly;
...
/**
 ...
 @note works for `EaseImageCoder`, `EaseProgressiveImageCoder`, `EaseAnimatedImageCoder`.
 */
FOUNDATION_EXPORT EaseImageCoderOption _Nonnull const EaseImageCoderDecodeScaleFactor;
...
/**
 ...
 @note works for `EaseImageCoder`, `EaseProgressiveImageCoder`, `EaseAnimatedImageCoder`.
 */
FOUNDATION_EXPORT EaseImageCoderOption _Nonnull const EaseImageCoderDecodePreserveAspectRatio;
...
/**
 ...
 @note works for `EaseImageCoder`, `EaseProgressiveImageCoder`, `EaseAnimatedImageCoder`.
 */
FOUNDATION_EXPORT EaseImageCoderOption _Nonnull const EaseImageCoderDecodeThumbnailPixelSize;
...
/**
 ...
 @note works for `EaseImageCoder`.
 */
FOUNDATION_EXPORT EaseImageCoderOption _Nonnull const EaseImageCoderEncodeFirstFrameOnly;
/**
 ...
 @note works for `EaseImageCoder`
 */
FOUNDATION_EXPORT EaseImageCoderOption _Nonnull const EaseImageCoderEncodeCompressionQuality;
...
/**
 ...
 @note works for `EaseImageCoder`
 */
FOUNDATION_EXPORT EaseImageCoderOption _Nonnull const EaseImageCoderEncodeBackgroundColor;
...
/**
 ...
 @note works for `EaseImageCoder`
 */
FOUNDATION_EXPORT EaseImageCoderOption _Nonnull const EaseImageCoderEncodeMaxFileSize;
...
/**
 ...
 @note works for `EaseImageCoder`
 */
FOUNDATION_EXPORT EaseImageCoderOption _Nonnull const EaseImageCoderEncodeEmbedThumbnail;

/**
 A EaseWebImageContext object which hold the original context options from top-level API. (EaseWebImageContext)
 ...
 See `EaseWebImageContext` for more detailed information.
 */
FOUNDATION_EXPORT EaseImageCoderOption _Nonnull const EaseImageCoderWebImageContext API_DEPRECATED("The coder component will be seperated from Core subspec in the future. Update your code to not rely on this context option.", macos(10.10, API_TO_BE_DEPRECATED), ios(8.0, API_TO_BE_DEPRECATED), tvos(9.0, API_TO_BE_DEPRECATED), watchos(2.0, API_TO_BE_DEPRECATED));
 ...
 */
@protocol EaseImageCoder <NSObject>
...
/**
 ...
 @note This protocol may supports decode animated image frames. You can use `+[EaseImageCoderHelper animatedImageWithFrames:]` to produce an animated image with frames.

 @param data The image data to be decoded
 @param options A dictionary containing any decoding options. Pass @{EaseImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for image. Pass @{EaseImageCoderDecodeFirstFrameOnly: @(YES)} to decode the first frame only.
 @return The decoded image from data
 */
- (nullable UIImage *)decodedImageWithData:(nullable NSData *)data
                                   options:(nullable EaseImageCoderOptions *)options;

#pragma mark - Encoding

/**
 Returns YES if this coder can encode some image. Otherwise, it should be passed to another coder.
 For custom coder which introduce new image format, you'd better define a new `EaseImageFormat` using like this. If you're creating public coder plugin for new image format, also update `https://github.com/rs/EaseWebImage/wiki/Coder-Plugin-List` to avoid same value been defined twice.
 * @code
 static const EaseImageFormat EaseImageFormatHEIF = 10;
 * @endcode
 
 @param format The image format
 @return YES if this coder can encode the image, NO otherwise
 */
- (BOOL)canEncodeToFormat:(EaseImageFormat)format NS_SWIFT_NAME(canEncode(to:));

/**
 Encode the image to image data.
 @note This protocol may supports encode animated image frames. You can use `+[EaseImageCoderHelper framesFromAnimatedImage:]` to assemble an animated image with frames.

 @param image The image to be encoded
 @param format The image format to encode, you should note `EaseImageFormatUndefined` format is also  possible
 @param options A dictionary containing any encoding options. Pass @{EaseImageCoderEncodeCompressionQuality: @(1)} to specify compression quality.
 @return The encoded image data
 */
- (nullable NSData *)encodedDataWithImage:(nullable UIImage *)image
                                   format:(EaseImageFormat)format
                                  options:(nullable EaseImageCoderOptions *)options;
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol EaseProgressiveImageCoder <EaseImageCoder>
...
/**
 ...
 @param options A dictionary containing any progressive decoding options (instance-level). Pass @{EaseImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for progressive animated image (each frames should use the same scale).
 @return A new instance to do incremental decoding for the specify image format
 */
- (nonnull instancetype)initIncrementalWithOptions:(nullable EaseImageCoderOptions *)options;
...
/**
 ...
 @note Due to the performance issue for progressive decoding and the integration for image view. This method may only return the first frame image even if the image data is animated image. If you want progressive animated image decoding, conform to `EaseAnimatedImageCoder` protocol as well and use `animatedImageFrameAtIndex:` instead.

 @param options A dictionary containing any progressive decoding options. Pass @{EaseImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for progressive image
 @return The decoded image from current data
 */
- (nullable UIImage *)incrementalDecodedImageWithOptions:(nullable EaseImageCoderOptions *)options;

@end

#pragma mark - Animated Image Provider
/**
 This is the animated image protocol to provide the basic function for animated image rendering. It's adopted by `EaseAnimatedImage` and `EaseAnimatedImageCoder`
 */
@protocol EaseAnimatedImageProvider <NSObject>
...
/**
 This is the animated image coder protocol for custom animated image class like  `EaseAnimatedImage`. Through it inherit from `EaseImageCoder`. We currentlly only use the method `canDecodeFromData:` to detect the proper coder for specify animated image format.
 */
@protocol EaseAnimatedImageCoder <EaseImageCoder, EaseAnimatedImageProvider>
...
/**
 ...
 After the instance created, we may call methods in `EaseAnimatedImageProvider` to produce animated image frame.

 @param data The animated image data to be decode
 @param options A dictionary containing any animated decoding options (instance-level). Pass @{EaseImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for animated image (each frames should use the same scale).
