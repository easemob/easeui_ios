...
typedef NSURLRequest * _Nullable (^EaseWebImageDownloaderRequestModifierBlock)(NSURLRequest * _Nonnull request);
 ...
 */
@protocol EaseWebImageDownloaderRequestModifier <NSObject>
 ...
 */
@interface EaseWebImageDownloaderRequestModifier : NSObject <EaseWebImageDownloaderRequestModifier>

/// Create the request modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull EaseWebImageDownloaderRequestModifierBlock)block;

/// Create the request modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)requestModifierWithBlock:(nonnull EaseWebImageDownloaderRequestModifierBlock)block;
...
*/
@interface EaseWebImageDownloaderRequestModifier (Conveniences)
