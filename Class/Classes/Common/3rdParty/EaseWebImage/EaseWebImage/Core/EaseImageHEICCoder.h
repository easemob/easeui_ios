...
/**
 ...
 @note If you need to support lower firmware version for HEIF, you can have a try at https://github.com/EaseWebImage/EaseWebImageHEIFCoder
 */
API_AVAILABLE(ios(13.0), tvos(13.0), macos(10.15), watchos(6.0))
@interface EaseImageHEICCoder : EaseImageIOAnimatedCoder <EaseProgressiveImageCoder, EaseAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) EaseImageHEICCoder *sharedCoder;
