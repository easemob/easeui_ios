...
/**
 ...
 For a full GIF support, we recommend `EaseAnimatedImageView` to keep both CPU and memory balanced.
 ...
 */
@interface EaseImageIOCoder : NSObject <EaseProgressiveImageCoder>

@property (nonatomic, class, readonly, nonnull) EaseImageIOCoder *sharedCoder;
