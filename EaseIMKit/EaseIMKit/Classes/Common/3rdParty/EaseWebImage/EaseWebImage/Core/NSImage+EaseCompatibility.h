...
/**
 This category is provided to easily write cross-platform(AppKit/UIKit) code. For common usage, see `UIImage+EaseMetadata.h`.
 */
@interface NSImage (EaseCompatibility)
