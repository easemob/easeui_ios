...
/**
 ...
 For the description about these methods, see `EaseWebImageDownloaderOperation`
 ...
 */
@protocol EaseWebImageDownloaderOperation <NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
@required
...
/**
 The download operation class for EaseWebImageDownloader.
 */
@interface EaseWebImageDownloaderOperation : NSOperation <EaseWebImageDownloaderOperation>
 ...
 */
@property (assign, nonatomic, readonly) EaseWebImageDownloaderOptions options;

/**
 * The context for the receiver.
 */
@property (copy, nonatomic, readonly, nullable) EaseWebImageContext *context;

/**
 *  Initializes a `EaseWebImageDownloaderOperation` object
 *
 *  @see EaseWebImageDownloaderOperation
 *
...
- (nonnull instancetype)initWithRequest:(nullable NSURLRequest *)request
                              inSession:(nullable NSURLSession *)session
                                options:(EaseWebImageDownloaderOptions)options
                                context:(nullable EaseWebImageContext *)context NS_DESIGNATED_INITIALIZER;
