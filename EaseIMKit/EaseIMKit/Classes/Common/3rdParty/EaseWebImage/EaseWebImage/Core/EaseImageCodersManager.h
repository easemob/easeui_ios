...
/**
 ...
 Coders
 ------
 A coder must conform to the `EaseImageCoder` protocol or even to `EaseProgressiveImageCoder` if it supports progressive decoding
 ...
 */
@interface EaseImageCodersManager : NSObject <EaseImageCoder>

/**
 Returns the global shared coders manager instance.
 */
@property (nonatomic, class, readonly, nonnull) EaseImageCodersManager *sharedManager;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<EaseImageCoder>> *coders;
