...
/**
 This class is used for creating animated images via `animatedImageWithFrames` in `EaseImageCoderHelper`.
 @note If you need to specify animated images loop count, use `Ease_imageLoopCount` property in `UIImage+EaseMetadata.h`.
 */
@interface EaseImageFrame : NSObject
