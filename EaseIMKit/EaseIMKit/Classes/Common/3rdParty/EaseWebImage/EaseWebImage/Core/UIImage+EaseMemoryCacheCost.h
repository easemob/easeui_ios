 ...
 */
@interface UIImage (EaseMemoryCacheCost)
...
/**
 ...
 @note For custom animated class conforms to `EaseAnimatedImage`, you can override this getter method in your subclass to return a more proper value instead, which representing the current frame's total bytes.
 */
@property (assign, nonatomic) NSUInteger Ease_memoryCost;
