...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Here we use the provided Ease_setImageWithURL:placeholderImage: method to load the web image
    // Ensure you use a placeholder image otherwise cells will be initialized with no image
    [cell.imageView Ease_setImageWithURL:[NSURL URLWithString:@"http://example.com/image.jpg"]
...
/**
 * Integrates EaseWebImage async downloading and caching of remote images with UIImageView.
 */
@interface UIImageView (EaseWebCache)
