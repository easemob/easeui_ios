...
typedef NSURLResponse * _Nullable (^EaseWebImageDownloaderResponseModifierBlock)(NSURLResponse * _Nonnull response);
 ...
 */
@protocol EaseWebImageDownloaderResponseModifier <NSObject>
...
/// @note If nil is returned, the image download will marked as cancelled with error `EaseWebImageErrorInvalidDownloadResponse`
 ...
 */
@interface EaseWebImageDownloaderResponseModifier : NSObject <EaseWebImageDownloaderResponseModifier>

/// Create the response modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull EaseWebImageDownloaderResponseModifierBlock)block;

/// Create the response modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)responseModifierWithBlock:(nonnull EaseWebImageDownloaderResponseModifierBlock)block;
...
*/
@interface EaseWebImageDownloaderResponseModifier (Conveniences)
