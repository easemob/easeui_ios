 ...
 */
@interface EaseImageCoderHelper : NSObject
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<EaseImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<EaseImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage NS_SWIFT_NAME(frames(from:));
