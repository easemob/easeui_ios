...
@class EaseAnimatedImg;
@protocol EaseAnimatedImgViewDebugDelegate;


//
//  An `EaseAnimatedImgView` can take an `EaseAnimatedImg` and plays it automatically when in view hierarchy and stops when removed.
...
//
@interface EaseAnimatedImgView : UIImageView
...
@property (nonatomic, strong) EaseAnimatedImg *animatedImage;
