...
// Notifications
#define EasePHOTO_LOADING_DID_END_NOTIFICATION @"EasePHOTO_LOADING_DID_END_NOTIFICATION"
#define EasePHOTO_PROGRESS_NOTIFICATION @"EasePHOTO_PROGRESS_NOTIFICATION"
...
// Otherwise you can use the EasePhoto object or subclass it yourself to
// store more information per photo.
//
// You can see the EasePhoto class for an example implementation of this protocol
//
@protocol EasePhoto <NSObject>
...
// notification:
// [[NSNotificationCenter defaultCenter] postNotificationName:EasePHOTO_LOADING_DID_END_NOTIFICATION
//                                                     object:self];
