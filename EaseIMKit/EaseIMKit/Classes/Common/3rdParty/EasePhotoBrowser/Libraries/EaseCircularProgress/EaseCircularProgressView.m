...
@interface EaseCircularProgressLayer : CALayer
...
@implementation EaseCircularProgressLayer
...
@interface EaseCircularProgressView ()

@end

@implementation EaseCircularProgressView

+ (void) initialize
{
    if (self != [EaseCircularProgressView class])
        return;
...
+ (Class)layerClass
{
    return [EaseCircularProgressLayer class];
}

- (EaseCircularProgressLayer *)circularProgressLayer
{
    return (EaseCircularProgressLayer *)self.layer;
}
