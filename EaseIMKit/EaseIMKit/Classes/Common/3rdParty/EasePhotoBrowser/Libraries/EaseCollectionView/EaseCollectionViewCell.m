...
@interface EaseCollectionReusableView () {
    EaseCollectionViewLayoutAttributes *_layoutAttributes;
...
@property (nonatomic, strong) EaseCollectionViewLayoutAttributes *layoutAttributes;
@end

@implementation EaseCollectionReusableView
