...
@interface EaseGridLayoutSection () {
...
@implementation EaseGridLayoutSection
...
- (EaseGridLayoutItem *)addItem {
    EaseGridLayoutItem *item = [EaseGridLayoutItem new];
    item.section = self;
...
- (EaseGridLayoutRow *)addRow {
    EaseGridLayoutRow *row = [EaseGridLayoutRow new];
    row.section = self;
    [_rows addObject:row];
    return row;
}
...
- (EaseGridLayoutSection *)snapshot {
    EaseGridLayoutSection *snapshotSection = [EaseGridLayoutSection new];
