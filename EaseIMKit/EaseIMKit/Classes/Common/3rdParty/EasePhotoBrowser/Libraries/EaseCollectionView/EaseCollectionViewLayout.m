...
@interface EaseCollectionView ()
- (id)currentUpdate;
- (NSDictionary *)visibleViewsDict;
- (EaseCollectionViewData *)collectionViewData;
- (CGRect)visibleBoundRects; // visibleBounds is flagged as private API (wtf)
@end

@interface EaseCollectionReusableView ()
...
@implementation EaseCollectionViewLayoutAttributes

///////////////////////////////////////////////////////////////////////////////////////////
#pragma mark - Static

+ (instancetype)layoutAttributesForCellWithIndexPath:(NSIndexPath *)indexPath {
    EaseCollectionViewLayoutAttributes *attributes = [self new];
    attributes.elementKind = PSTCollectionElementKindCell;
    attributes.elementCategory = EaseCollectionViewItemTypeCell;
...
+ (instancetype)layoutAttributesForSupplementaryViewOfKind:(NSString *)elementKind withIndexPath:(NSIndexPath *)indexPath {
    EaseCollectionViewLayoutAttributes *attributes = [self new];
    attributes.elementCategory = EaseCollectionViewItemTypeSupplementaryView;
...
+ (instancetype)layoutAttributesForDecorationViewOfKind:(NSString *)elementKind withIndexPath:(NSIndexPath *)indexPath {
    EaseCollectionViewLayoutAttributes *attributes = [self new];
    attributes.elementCategory = EaseCollectionViewItemTypeDecorationView;
    attributes.elementKind = elementKind;
    attributes.indexPath = indexPath;
    return attributes;
}
...
- (BOOL)isEqual:(id)other {
    if ([other isKindOfClass:self.class]) {
        EaseCollectionViewLayoutAttributes *otherLayoutAttributes = (EaseCollectionViewLayoutAttributes *)other;
...
- (EaseCollectionViewItemType)representedElementCategory {
...
- (BOOL)isDecorationView {
    return self.representedElementCategory == EaseCollectionViewItemTypeDecorationView;
}

- (BOOL)isSupplementaryView {
    return self.representedElementCategory == EaseCollectionViewItemTypeSupplementaryView;
}

- (BOOL)isCell {
    return self.representedElementCategory == EaseCollectionViewItemTypeCell;
}
...
- (id)copyWithZone:(NSZone *)zone {
    EaseCollectionViewLayoutAttributes *layoutAttributes = [self.class new];
...
@interface EaseCollectionViewLayout () {
    __unsafe_unretained EaseCollectionView *_collectionView;
...
@implementation EaseCollectionViewLayout
///////////////////////////////////////////////////////////////////////////////////////////
#pragma mark - NSObject
...
- (void)setCollectionView:(EaseCollectionView *)collectionView {
...
+ (Class)layoutAttributesClass {
    return EaseCollectionViewLayoutAttributes.class;
}
...
- (EaseCollectionViewLayoutAttributes *)layoutAttributesForDecorationViewOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    return nil;
}
...
- (void)prepareForCollectionViewUpdates:(NSArray *)updateItems {
    ...
    for (EaseCollectionReusableView *view in [[_collectionView visibleViewsDict] objectEnumerator]) {
        EaseCollectionViewLayoutAttributes *attr = [view.layoutAttributes copy];
        if (attr) {
            if (attr.isCell) {
            ...
            _initialAnimationLayoutAttributesDict[[EaseCollectionViewItemKey collectionItemKeyForLayoutAttributes:attr]] = attr;
        }
    }

    EaseCollectionViewData *collectionViewData = [_collectionView collectionViewData];

    CGRect bounds = [_collectionView visibleBoundRects];

    for (EaseCollectionViewLayoutAttributes *attr in [collectionViewData layoutAttributesForElementsInRect:bounds]) {
        if (attr.isCell) {
            ...
            if (index != NSNotFound) {
                EaseCollectionViewLayoutAttributes *finalAttrs = [attr copy];
                [finalAttrs setIndexPath:[update[@"oldModel"] indexPathForItemAtGlobalIndex:index]];
                [finalAttrs setAlpha:0];
                _finalAnimationLayoutAttributesDict[[EaseCollectionViewItemKey collectionItemKeyForLayoutAttributes:finalAttrs]] = finalAttrs;
            }
        }
    }

    for (EaseCollectionViewUpdateItem *updateItem in updateItems) {
        ...
        if ([updateItem isSectionOperation]) {
            ...
            if (action == PSTCollectionUpdateActionDelete) {
                EaseCollectionViewItemKey *key = [EaseCollectionViewItemKey collectionItemKeyForCellWithIndexPath:
                        [updateItem indexPathBeforeUpdate]];

                EaseCollectionViewLayoutAttributes *attrs = [_finalAnimationLayoutAttributesDict[key] copy];
                ...
                EaseCollectionViewLayoutAttributes *attrs = [_initialAnimationLayoutAttributesDict[key] copy];
...
- (EaseCollectionViewLayoutAttributes *)initialLayoutAttributesForAppearingItemAtIndexPath:(NSIndexPath *)itemIndexPath {
    EaseCollectionViewLayoutAttributes *attrs = _initialAnimationLayoutAttributesDict[[EaseCollectionViewItemKey collectionItemKeyForCellWithIndexPath:itemIndexPath]];
...
- (EaseCollectionViewLayoutAttributes *)finalLayoutAttributesForDisappearingItemAtIndexPath:(NSIndexPath *)itemIndexPath {
    EaseCollectionViewLayoutAttributes *attrs = _finalAnimationLayoutAttributesDict[[EaseCollectionViewItemKey collectionItemKeyForCellWithIndexPath:itemIndexPath]];
...
- (EaseCollectionViewLayoutAttributes *)initialLayoutAttributesForInsertedSupplementaryElementOfKind:(NSString *)elementKind atIndexPath:(NSIndexPath *)elementIndexPath {
    EaseCollectionViewLayoutAttributes *attrs = _initialAnimationLayoutAttributesDict[[EaseCollectionViewItemKey collectionItemKeyForCellWithIndexPath:elementIndexPath]];
...
- (EaseCollectionViewLayoutAttributes *)finalLayoutAttributesForDeletedSupplementaryElementOfKind:(NSString *)elementKind atIndexPath:(NSIndexPath *)elementIndexPath {
    return nil;
}
