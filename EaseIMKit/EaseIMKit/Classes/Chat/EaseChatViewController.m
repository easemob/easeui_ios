...
- (void)_setupChatBarMoreViews
{
    ...
    EaseExtMenuModel *sealRtcExtModel = [[EaseExtMenuModel alloc]initWithData:[UIImage easeUIImageNamed:@"video_conf"] funcDesc:@"音视频" handle:^(NSString * _Nonnull itemDesc, BOOL isExecuted) {
